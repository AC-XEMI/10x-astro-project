...
import { $ as joinPaths, Bt as MissingImageDimension, Nt as InvalidImageService, Pt as LocalImageUsedWrongly, Q as isRemotePath, T as shorthash, Vt as NoImageMetadata, bt as ExpectedNotESMImage, dt as AstroError, en as UnsupportedImageConversion, kt as IncompatibleDescriptorOptions, qt as RemoteImageNotAllowed, rt as removeQueryString, tn as UnsupportedImageFormat, vt as ExpectedImage, xt as FailedToFetchRemoteImageDimensions, yt as ExpectedImageOptions } from "./runtime_zVK3H1hm.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_BUdpiYrn.mjs").catch((e) => {
...
//#endregion
export { baseService as a, isESMImportedImage as c, isRemoteAllowed as d, matchPattern as f, getImage as i, isRemoteImage as l, propsToFilename as n, inferRemoteSize as o, getConfiguredImageService as r, fetchWithRedirects as s, hashTransform as t, resolveSrc as u };
