...
import { an as __toESM } from "./runtime_zVK3H1hm.mjs";
import { t as require_react } from "./react_DBxBzWad.mjs";
//#region node_modules/ultrahtml/dist/index.js
...
function convert(children) {
	...
	function createReactElementFromNode(node) {
		...
		if (node.type === 0) return (0, import_react.createElement)(import_react.Fragment, {}, childVnodes);
		else if (node.type === 1) {
			const { class: className, ...props } = node.attributes;
			return (0, import_react.createElement)(node.name, {
				...props,
				className,
				key: `${id}-${key++}`
			}, childVnodes);
