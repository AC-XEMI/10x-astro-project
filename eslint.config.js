...
export default defineConfig(
  ...
  { ignores: ["src/types.ts"] }, // generated by `npm run db:types`; not hand-formatted, exclude from lint
  { ignores: [".claude/**"] }, // agent skill definitions/tooling, not application source
  baseConfig,
  reactConfig,
